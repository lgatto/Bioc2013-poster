  ...
  \begin{columns}
    \begin{column}{.48\textwidth}
     ...
     \begin{block}{Introduction}
       ...
       required investing time and effort in the exploration and analysis of the data.
...
\end{figure}
    ...
    \begin{column}{.48\textwidth}
      ...
      \begin{block}{Peptide identification}
        ...
        search engine in \R and uses the same XML-based parameter files as the native application. Result 
        files can be directly parsed and mined in \R.   
...
@       
        ...
        \bigskip        
        \textbf{Challenges} Better integration of identification and raw/quantitation data infrastructure.        
