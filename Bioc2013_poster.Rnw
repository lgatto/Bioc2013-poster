...
\newcommand{\challenge}[1]{
       \begin{tcolorbox}[notitle,boxrule=0pt,colback=blue!10,colframe=blue!10]\textbf{Challenges}~{#1}
       \end{tcolorbox}
}
...
\Rpackage{xcms}, \Rpackage{MSnbase}, \Rpackage{RMassBank} and \Rpackage{TargetSearch}.
       ...
       \bigskip
         ...
         \challenge{Further improve support of raw MS data and develop the range of supported formats, 
...
\end{figure}
    ...
    \begin{column}{.48\textwidth}
      ...
      \begin{block}{Label-free quantitation}
        ...
        \bigskip        
        \challenge{Application and benchmarking of label-free pipeline on popular Thermo Orbitrap instruments.}
      \end{block}
      %%\vfill
